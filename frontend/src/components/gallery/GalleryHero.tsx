  ...
  return (
    <section className="relative w-full bg-ec-dark">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/images/main-gallery/DM6A4162-2.jpg')",
      ...
      >
        <motion.div
          {...fadeUp}
          className="absolute bottom-[55px] left-[35px] flex w-auto max-w-[483px] items-center bg-black/[0.63] px-[40px] py-[35px]"
        >
