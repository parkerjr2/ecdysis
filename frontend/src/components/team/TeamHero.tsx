  ...
  return (
    <section className="relative w-full bg-ec-dark">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/images/team/16X24-Print-9.png')",
      ...
      >
        <motion.div
          {...fadeUp}
          className="absolute bottom-[55px] left-[35px] flex h-[126px] w-auto items-center justify-center bg-black/[0.63] px-[40px] py-[35px]"
        >
