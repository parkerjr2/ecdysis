  ...
  return (
    ...
    >
      ...
      >
        <motion.div
          {...fadeUp}
          className="absolute bottom-[55px] left-[35px] flex h-[126px] w-[205px] items-center justify-center bg-black/[0.63]"
        >
      ...
      <div className="w-full bg-ec-dark py-[75px]">
        <div className="mx-auto flex w-full max-w-[1200px] flex-col bg-white">
          <div className="flex flex-col items-center px-6 pb-[40px] pt-[45px] md:px-[30px]">
            <motion.h2
              {...fadeUp}
              className="text-center font-script text-[44px] leading-[1] tracking-[1.5px] text-black md:text-[60px]"
            >
              Thank You, Broken Arrow!
            </motion.h2>
            <motion.p
              {...fadeUp}
              className="mt-6 max-w-[820px] text-center font-sans text-[18px] font-light leading-[28px] text-black md:text-[20px] md:leading-[30px]"
            >
          ...
          <motion.div
            {...fadeUp}
            className="grid w-full grid-cols-1 gap-0 md:grid-cols-3"
          >
